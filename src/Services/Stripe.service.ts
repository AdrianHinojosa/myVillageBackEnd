...
// Trial length for a new subscription. Punto 18: ajustado de 30 a 14 días naturales para TODAS
// las modalidades (decisión PO 2026-09-22). Solo afecta suscripciones NUEVAS (Stripe fija el
// trial al crear la suscripción), por lo que las suscripciones vivas no cambian.
