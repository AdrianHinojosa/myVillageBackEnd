...
const statesData = require(path.join(__dirname, `../../../seeds${COUNTRYNAME}/states_${COUNTRYNAMELOWER}.json`));
const citiesData = require(path.join(__dirname, `../../../seeds${COUNTRYNAME}/cities_${COUNTRYNAMELOWER}.json`));

// Generate consistent UUID for this country (you can also hardcode this if needed)
const COUNTRY_ID = `0885ca64-7370-47ce-ba81-78cf86375929`; // Fixed UUID for ${COUNTRYNAME}
